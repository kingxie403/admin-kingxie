...
<div>
    <img id="processDiagram" src="${ctx }/flow/read/resource?pdid=${historicProcessInstance.processDefinitionId}&resourceName=${processDefinition.diagramResourceName}" />
</div>

 通过引擎自动生成图片并用红色边框标注
<div>
    <img id="processDiagramAuto" src="${ctx }/process/trace/data/auto/${historicProcessInstance.processInstanceId}" />
</div>
