...
package com.lte.controller.activiti.rest.diagram.services;
...
public class BaseProcessDefinitionDiagramLayoutResource {
  ...
  public ObjectNode getDiagramNode(String processInstanceId, String processDefinitionId) {
    ...
    if (processInstance != null) {
      ...
      highLightedFlows = TraceUtil.getHighLightedFlows(processDefinition,processInstanceId,historyService,runtimeService);
